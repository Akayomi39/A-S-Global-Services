...
const RESULT_IMAGES = [
    { src:'ergebnis-1.jpg', alt:'Entrümpelung – Vorher und Nachher, Wohnzimmer' },
    { src:'ergebnis-2.jpg', alt:'Entrümpelung – Vorher und Nachher, Schlafzimmer' },
    { src:'ergebnis-3.jpg', alt:'Entrümpelung – Vorher und Nachher, Keller' },
    { src:'ergebnis-4.jpg', alt:'Entrümpelung – Vorher und Nachher, Küche' },
];
let activeResult = 0;
...
const FAQS = [
    ...
    },
    {
        ...
        items: [
            { q:'Welche Möbel könnt ihr montieren?', a:'Wir montieren zum Beispiel Schränke, Regale, Betten, Kommoden, Tische und weitere Möbel. Beschreiben Sie uns kurz, worum es geht – dann können wir den Aufwand besser einschätzen.' },
            { q:'Muss ich für die Montage vor Ort sein?', a:'Das ist nicht zwingend nötig. Wichtig ist nur, dass wir Zugang zu den Möbeln und zum Raum haben und mögliche Besonderheiten vorab besprochen wurden.' }
        ]
    },
    {
        category: '🚚 Umzug',
        items: [
            { q:'Übernehmt ihr auch kleinere Umzüge?', a:'Ja. Ob einzelne Möbelstücke, ein Kleintransport oder ein kompletter Wohnungsumzug: Wir planen den Umfang passend zu Ihrem Bedarf.' },
            { q:'Könnt ihr Möbel beim Umzug auch auf- und abbauen?', a:'Ja, Möbelmontage kann direkt mit dem Umzug kombiniert werden. Geben Sie das einfach bei Ihrer Anfrage an, damit wir genug Zeit und Material einplanen.' }
        ]
    },
    {
